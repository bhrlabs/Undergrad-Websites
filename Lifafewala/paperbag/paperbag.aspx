<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paperbag.aspx.cs" Inherits="paperbags_paperbag" %>
...
<body style="background-image:url(../qqq1.jpg);">
    <form id="form1" runat="server">
    <table id="pageTable" width="1340px">
        <tr>
            <td id="header" colspan='2'>
                <a href="../index.aspx"><asp:Image ID="Image1" runat="server" ImageUrl="../images/logo.png" ImageAlign="Left"
            ...
            <td id="navshell">
                ...
                <div class="container" align="center">
                    <ul id="sti-menu" class="sti-menu">
                        ...
                        <li data-hovercolor="#fff"><a href="../corrubox/corrubox.aspx">
                            <h2 data-type="mText" class="sti-item">
                                Corrugated Boxes</h2>
                            <h3 data-type="sText" class="sti-item">
                            </h3>
