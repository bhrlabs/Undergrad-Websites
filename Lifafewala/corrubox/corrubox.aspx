<%@ Page Language="C#" AutoEventWireup="true" CodeFile="corrubox.aspx.cs" Inherits="corrubox_corrubox" %>
    ...
    <table id="pageTable" width="1340px">
        <tr>
            <td id="header" colspan='2'>
                <a href="../index.aspx"><asp:Image ID="Image1" runat="server" ImageUrl="~/images/logo1.png" ImageAlign="Left"
