...
<%@ PreviousPageType VirtualPath="~/Administrator/Checkdatabase.aspx"  %>
...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If (Not Page.IsPostBack And Request.UrlReferrer.ToString().Contains("~/Administrator/Checkdatabase.aspx")) Then
            
            Dim txtfield As String = PreviousPage.alphafield()
            Dim txtalphabet As String = PreviousPage.alphatext()
            ...
            mysql.Append(" WHERE [EventName] LIKE '" + email + "'")
            mysql.Append("AND [" + txtfield + "] LIKE '" + txtalphabet + "%'")
    ...
    Protected Sub backimg_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Response.Redirect("~/Administrator/Checkdatabase.aspx")
    End Sub
</script>
...
<asp:Panel runat="server" ID="pane11" ScrollBars="Horizontal" Width="620px">
